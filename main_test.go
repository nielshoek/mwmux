...
func Test_BasicMiddleware_RunsOneHandlerFunc(t *testing.T) {
	...
	requestPath := "/a"
	middlewarePath := "/a"
	MyMux.Use(middlewarePath, func(w http.ResponseWriter, r *http.Request) {
...
func Test_MiddlewareTwoLevelsDeep_RunsTwoHandlerFuncs(t *testing.T) {
	...
	requestPath := "/a/b"
	middlewarePathOne := "/a"
	MyMux.Use(middlewarePathOne, func(w http.ResponseWriter, r *http.Request) {
		hitPaths[middlewarePathOne] = Void{}
	})
	middlewarePathTwo := "/a/b"
	MyMux.Use(middlewarePathTwo, func(w http.ResponseWriter, r *http.Request) {
